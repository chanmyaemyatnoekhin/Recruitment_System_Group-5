...
<body>
    <div class="container">
        ...
        <input type="text" id="fullName" name="fullName" oninput="validateNameInput(this)" placeholder="your full name" required>
        <span id="nameError" style="color:red;"></span><br><br>


           <label for="email">Email *</label>
           <!-- other fields -->
			<input type="email" id="email" name="email" placeholder="example@domain.com" onblur="validateEmail(this)" required>
			<span id="emailError" style="color:red;"></span>

            <label for="phone">Phone Number *</label>
             <!-- other fields --> 
        <input type="tel" id="phone" name="phone" oninput="validatePhoneInput(this)" required>
        <span id="phoneError" style="color:red;"></span><br><br>
           ...
           <div class="nrc-container">
				  ...
				  <div class="nrc-field">			    
				  		  <input type="number" id="nrc-number" placeholder="e.g., 112334" oninput="updatePreview()" required>
				  </div>
